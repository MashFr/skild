...
export const dummySkills: SkillRecord[] = [
  {
    ...
    title: "Write Code",
    slug: "write-code",
    description: "Learn to write clean, maintainable TypeScript code with modern patterns and best practices.",
  ...
  },
  {
    ...
    title: "Docker Basics",
    slug: "docker-basics",
    description: "Understand containerization, Dockerfiles, Docker Compose, and container orchestration fundamentals.",
    category: "devops",
  ...
  },
  {
    ...
    title: "React Hooks",
    slug: "react-hooks",
    description: "Master useState, useEffect, useContext, and custom hooks to build reactive UIs.",
    category: "frontend",
  ...
  },
  {
    ...
    title: "SQL Querying",
    slug: "sql-querying",
    description: "Write efficient SQL queries including joins, subqueries, aggregations, and window functions.",
    category: "data",
  ...
  },
  {
    ...
    description: "Collaborate effectively using Git branching strategies, pull requests, rebasing, and conflict resolution.",
    category: "tools",
